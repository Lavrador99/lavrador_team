...
const ALL_ACHIEVEMENTS: {
  ...
  },
  {
    ...
    name: '10 Treinos',
    icon: '💪',
    description: 'Completaste 10 treinos no total.',
  },
  {
    type: 'WORKOUTS_50',
    name: '50 Treinos',
    icon: '🌟',
    description: 'Completaste 50 treinos no total.',
  },
  {
    type: 'WORKOUTS_100',
    name: '100 Treinos',
    icon: '🎖️',
    description: 'Lenda! 100 treinos completados.',
  },
  {
    type: 'FIRST_PR',
    name: 'Primeiro recorde',
    icon: '📈',
    description: 'Bateste o teu primeiro recorde pessoal!',
  },
  {
    type: 'PRS_5',
    name: '5 Recordes',
    icon: '🏅',
    description: 'Bateste 5 recordes pessoais!',
  },
  {
    type: 'CONSISTENCY_MONTH',
    name: 'Consistência',
    icon: '📅',
    description: '20+ treinos num mês. Incrível!',
  },
];

export default function AchievementsPage() {
  const { data } = useSWR<AchievementDto[]>(
    `${API}/api/achievements/my`,
    fetcher
  );
  const earned: AchievementDto[] = Array.isArray(data) ? data : [];
        ...
        {ALL_ACHIEVEMENTS.map((a) => {
          ...
          return (
            ...
            >
              ...
              <div className="font-label text-xs text-secondary leading-tight">
                {a.description}
              </div>
              {earnedData && (
